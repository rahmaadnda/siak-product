...
public class InformasiResourceImpl extends InformasiResourceDecorator {
  ...
  @Restricted(permissionName = "SaveInformasiIndustri")
  @Route(url = "call/informasiindustri/save")
  ...
  @Restricted(permissionName = "UpdateInformasiIndustri")
  @Route(url = "call/informasiindustri/update")
  ...
  @Restricted(permissionName = "ReadInformasiIndustri")
  @Route(url = "call/informasiindustri/detail")
  ...
  @Restricted(permissionName = "ReadInformasiIndustri")
  @Route(url = "call/informasiindustri/list")
  ...
  @Restricted(permissionName = "DeleteInformasiIndustri")
  @Route(url = "call/informasiindustri/delete")

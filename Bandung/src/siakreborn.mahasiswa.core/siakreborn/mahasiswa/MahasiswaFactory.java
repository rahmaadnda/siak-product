...
public class MahasiswaFactory{
    ...
    public MahasiswaFactory()
    {

    }

    public static Mahasiswa createMahasiswa(String fullyQualifiedName, Object ... base)
    {
        Mahasiswa record = null;
        if (true) {
            try {
                ...
                for (int i = 0; i < constructorList.length; i++) {
                    try {
                        ...
                        record = (Mahasiswa) constructor.newInstance(base);

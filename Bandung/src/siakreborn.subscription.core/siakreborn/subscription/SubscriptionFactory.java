...
import siakreborn.subscription.core.Subscription;
...
public class SubscriptionFactory {
  ...
  public static Subscription createSubscription(String fullyQualifiedName, Object... base) {
    ...
    try {
      ...
      for (int i = 0; i < constructorList.length; i++) {
        try {
          ...
          record = (Subscription) constructor.newInstance(base);

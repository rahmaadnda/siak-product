...
import siakreborn.kurikulumsemester.core.KurikulumSemester;
import java.lang.reflect.Constructor;
import java.util.logging.Logger;

public class KurikulumSemesterFactory {
  private static final Logger LOGGER = Logger.getLogger(KurikulumSemesterFactory.class.getName());

  public KurikulumSemesterFactory() {

  }

  public static KurikulumSemester createKurikulumSemester(String fullyQualifiedName, Object... base) {
    KurikulumSemester record = null;
    try {
      ...
      for (int i = 0; i < constructorList.length; i++) {
        try {
          ...
          record = (KurikulumSemester) constructor.newInstance(base);

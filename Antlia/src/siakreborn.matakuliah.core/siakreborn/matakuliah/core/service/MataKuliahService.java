...
public interface MataKuliahService {
  ...
  List<MataKuliah> filterMataKuliahByProgramStudi(UUID programStudiId);

  List<MataKuliah> filterMataKuliahByParentMataKuliah(UUID parentMataKuliahId);

  List<MataKuliah> filterMataKuliahByKurikulum(UUID kurikulumId);

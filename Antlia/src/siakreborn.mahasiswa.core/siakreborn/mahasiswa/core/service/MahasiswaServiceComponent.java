...
public abstract class MahasiswaServiceComponent implements MahasiswaService {
  ...
  public abstract List<Mahasiswa> filterNotGraduated(String columnName, UUID id);

  public abstract List<Mahasiswa> getAllMahasiswaPublic();

  public abstract List<Mahasiswa> filterMahasiswa(String columnName, UUID id);

  public abstract List<Mahasiswa> filterMahasiswaPublic(String columnName, UUID id);
  ...
  public abstract Mahasiswa filterVerify(HashMap<String, Object> body);

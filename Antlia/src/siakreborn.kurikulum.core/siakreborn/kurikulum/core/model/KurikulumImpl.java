...
public class KurikulumImpl extends KurikulumComponent {
	...
	public KurikulumImpl(String kode, String noSK, String status, String profilLulusan, ProgramStudi programStudi, byte[] sKUrl) {
	...
	public KurikulumImpl(UUID id, String kode, String noSK, String status, String profilLulusan, ProgramStudi programStudi, byte[] sKUrl) {
		this.id = id;
		this.kode = kode;
		this.noSK = noSK;
		this.status = status;

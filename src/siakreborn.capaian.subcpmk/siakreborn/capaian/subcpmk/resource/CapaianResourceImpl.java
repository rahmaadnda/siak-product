...
public class CapaianResourceImpl extends CapaianResourceDecorator {
  ...
  @Restricted(permissionName = "SaveSubCPMK")
  ...
  @Restricted(permissionName = "UpdateSubCPMK")
  ...
  @Restricted(permissionName = "ReadSubCPMK")
  ...
  @Restricted(permissionName = "DeleteSubCPMK")

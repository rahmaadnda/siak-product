...
public class ObserverResourceImpl extends ObserverResourceDecorator {
  ...
  @Restricted(permissionName = "ReadAlumniPublic")
  @Route(url = "call/alumni/listpublic/filter")
  public List<HashMap<String, Object>> filterObserverPublic(VMJExchange vmjExchange) {
    ...
    if (by.equals("programStudi")) {
      ...
      List<Observer> observerList = ((ObserverServiceImpl) observerService).filterObserverPublic(id);
      return observerService.transformObserverListToHashMap(observerList);
    }
  ...
  @Restricted(permissionName = "ReadAlumni")
  @Route(url = "call/alumni/filter")
  public List<HashMap<String, Object>> filterObserver(VMJExchange vmjExchange) {
    String by = (String) vmjExchange.getGETParam("by");
    ...
    if (by.equals("programStudi")) {
      ...
      List<Observer> observerList = ((ObserverServiceImpl) observerService).filterObserver(id);
      return observerService.transformObserverListToHashMap(observerList);
    }
  ...
  @Restricted(permissionName = "VerifyAlumni")
  @Route(url = "call/alumni/verify/filter")
  public HashMap<String, Object> filterVerify(VMJExchange vmjExchange) {
    Observer verified = ((ObserverServiceImpl) observerService).filterVerify((HashMap<String, Object>) vmjExchange.getPayload());

package siakreborn.product.universitascaelum;
...
public class UniversitasCaelum {
	...
	public static void createObjectsAndBindEndPoints() {
        ...
        MataKuliahPrasyaratService sudahmengambilMataKuliahPrasyaratService = MataKuliahPrasyaratServiceFactory
            .createMataKuliahPrasyaratService("siakreborn.matakuliahprasyarat.sudahmengambil.MataKuliahPrasyaratServiceImpl"
            	, matakuliahprasyaratMataKuliahPrasyaratService);		

        MataKuliahPrasyaratResource sudahmengambilMataKuliahPrasyaratResource = MataKuliahPrasyaratResourceFactory
            .createMataKuliahPrasyaratResource("siakreborn.matakuliahprasyarat.sudahmengambil.MataKuliahPrasyaratResourceImpl"
                , matakuliahprasyaratMataKuliahPrasyaratResource, matakuliahprasyaratMataKuliahPrasyaratService);
		...
		System.out.println("sudahmengambilMataKuliahPrasyaratResource endpoints binding");
		Router.route(sudahmengambilMataKuliahPrasyaratResource);
		
		System.out.println("sudahmengambilMataKuliahPrasyaratService endpoints binding");
		Router.route(sudahmengambilMataKuliahPrasyaratService);

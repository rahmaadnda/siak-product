...
public interface MahasiswaService {
  ...
  List<Mahasiswa> filterNotGraduated(String columnName, UUID id);

  List<Mahasiswa> getAllMahasiswaPublic();

  List<Mahasiswa> filterMahasiswa(String columnName, UUID id);

  List<Mahasiswa> filterMahasiswaPublic(String columnName, UUID id);
  ...
  Mahasiswa filterVerify(HashMap<String, Object> body);

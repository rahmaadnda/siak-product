...
public class MahasiswaResourceImpl extends MahasiswaResourceComponent {
  ...
  @Restricted(permissionName = "ReadMahasiswa")
  @Route(url = "call/mahasiswa/listnotgraduated/filter")
  public List<HashMap<String, Object>> filterNotGraduated(VMJExchange vmjExchange) {
    ...
    if (by.equals("programStudi")) {
      ...
      List<Mahasiswa> mahasiswaList = mahasiswaService.filterNotGraduated(columnName, id);
      return mahasiswaService.transformMahasiswaListToHashMap(mahasiswaList);
    }
  ...
  @Restricted(permissionName = "VerifyMahasiswa")
  @Route(url = "call/mahasiswa/verify/filter")
  public HashMap<String, Object> filterVerify(VMJExchange vmjExchange) {
		Mahasiswa verified = mahasiswaService.filterVerify((HashMap<String, Object>) vmjExchange.getPayload());
  ...
  @Restricted(permissionName = "ReadMahasiswaPublic")
  @Route(url = "call/mahasiswa/listpublic/filter")
  public List<HashMap<String, Object>> filterMahasiswaPublic(VMJExchange vmjExchange) {
    String by = (String) vmjExchange.getGETParam("by");
    if (by.equals("programStudi")) {
      String idStr = (String) vmjExchange.getGETParam(by + "Id");
      if(idStr == null) {
      ...
      List<Mahasiswa> mahasiswaList = mahasiswaService.filterMahasiswaPublic(columnName, id);
      return mahasiswaService.transformMahasiswaListToHashMap(mahasiswaList);
    }
  ...
  @Restricted(permissionName = "ReadMahasiswa")
  @Route(url = "call/mahasiswa/filter")
  public List<HashMap<String, Object>> filterMahasiswa(VMJExchange vmjExchange) {
    String by = (String) vmjExchange.getGETParam("by");
    ...
    if (by.equals("programStudi")) {
      ...
      List<Mahasiswa> mahasiswaList = mahasiswaService.filterMahasiswa(columnName, id);
      return mahasiswaService.transformMahasiswaListToHashMap(mahasiswaList);
    }

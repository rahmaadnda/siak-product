...
public abstract class MataKuliahServiceDecorator extends MataKuliahServiceComponent {
  ...
  public List<MataKuliah> filterMataKuliahByProgramStudi(UUID programStudiId) {
    return record.filterMataKuliahByProgramStudi(programStudiId);
  }

  public List<MataKuliah> filterMataKuliahByParentMataKuliah(UUID parentMataKuliahId) {
    return record.filterMataKuliahByParentMataKuliah(parentMataKuliahId);
  }

  public List<MataKuliah> filterMataKuliahByKurikulum(UUID kurikulumId) {
    return record.filterMataKuliahByKurikulum(kurikulumId);
  }

  ...
  public List<HashMap<String, Object>> filterMataKuliah(VMJExchange vmjExchange) {
    ...
    if (by.equals("parentMataKuliah") || by.equals("programStudi")) {
      ...
      if (by.equals("parentMataKuliah")) {
        mataKuliahList = mataKuliahService.filterMataKuliahByParentMataKuliah(id);
      } 
      else if (by.equals("programStudi")) {
        mataKuliahList = mataKuliahService.filterMataKuliahByProgramStudi(id);
      }
      return mataKuliahService.transformMataKuliahListToHashMap(mataKuliahList);
    }
